...
@Data
@NoArgsConstructor
public class Proyecto_inventario_recursosDTO {
    @Id
    ...
    public Proyecto_inventario_recursosDTO(	@JsonProperty("id") int id,@JsonProperty("bsc_proyecto_inventario_pedido_id") int bsc_proyecto_inventario_pedido_id, 
